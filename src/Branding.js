...
export default function Branding ({meta}) {
	return (
		<header className="px-4 py-24 bg-slate-700 shadow-xl">
			<a className="block bg-white max-w-sm m-auto text-center duration-300 text-slate-400 hover:bg-blue-200 hover:text-slate-700" href="https://reactry.github.io/shades/">
